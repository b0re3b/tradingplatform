...
class RiskManager:
    ...
    def _serialize_decision(
        ...
        return {
            ...
            "decision": decision.decision.value,
            "risk_mode": decision.risk_mode.value,
            "entry_price": decision.entry_price if decision.entry_price is not None else request.entry_price,
            "stop_loss": decision.stop_loss if decision.stop_loss is not None else request.stop_loss,
            "take_profit": decision.take_profit if decision.take_profit is not None else request.take_profit,
            "order_intent": request.order_intent.value,
